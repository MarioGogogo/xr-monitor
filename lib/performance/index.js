    ...
    new PerformanceObserver((entryList, observer) => {
      ...
      if (firstInput) {
        ...
        if (inputDelay > 0 || duration > 0) {
          ...
          report.send({
            type: 'performance', //用户体验指标
            eventType: 'firstInputDelay', //首次输入延迟
            inputDelay, //延时的时间
            duration, //处理的时间
      ...
      observer.disconnect(); //不再观察了
    }).observe({ type: 'performance', buffered: true }); //观察页面中的意义的元素
  }
